...
const GetApproveTask = () => {
    ...
    const fetchUserApprovedTaskSolutions = async () => {
      try {
        ...
        const response = await axios.get(
          baseUrl + `/api/user-approved-task-solution/${id}/`,
          {
            headers: {
              token: token,
            },
  ...
  return (
    <div className="text-2xl ">
      <h2 className="text-center mt-10">User's Approved Task Solutions</h2>
      <ul>
